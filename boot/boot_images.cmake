...
if(DEFINED EFI_PLATFORM_ID)
    add_custom_target(efisys
        COMMAND native-fatten ${CMAKE_CURRENT_BINARY_DIR}/efisys.bin -format 2880 EFIBOOT
            ...
            -add ${CMAKE_SOURCE_DIR}/tools/limine/limine-binary/BOOTIA32.EFI EFI/BOOT/bootia32.efi
            -add ${CMAKE_SOURCE_DIR}/tools/limine/limine-binary/BOOTX64.EFI EFI/BOOT/bootx64.efi
            -add ${CMAKE_SOURCE_DIR}/boot/limine.conf EFI/BOOT/limine.conf
            -add ${CMAKE_SOURCE_DIR}/boot/limine.conf limine.conf
...
add_custom_target(bootcd
    ...
    COMMAND ${CMAKE_COMMAND} -E copy_if_different ${REACTOS_BINARY_DIR}/bootcd.iso ${CMAKE_SOURCE_DIR}/bootcd.iso
...
# Add Limine files into CD image
add_cd_file(FILE ${CMAKE_SOURCE_DIR}/tools/limine/limine-binary/BOOTIA32.EFI DESTINATION efi/boot NO_CAB NAME_ON_CD bootia32.efi FOR bootcd regtest livecd)
add_cd_file(FILE ${CMAKE_SOURCE_DIR}/tools/limine/limine-binary/BOOTX64.EFI DESTINATION efi/boot NO_CAB NAME_ON_CD bootx64.efi FOR bootcd regtest livecd)
add_cd_file(FILE ${CMAKE_SOURCE_DIR}/tools/limine/limine-binary/limine-bios-cd.bin DESTINATION boot NO_CAB FOR bootcd regtest livecd)
add_cd_file(FILE ${CMAKE_SOURCE_DIR}/tools/limine/limine-binary/limine-bios.sys DESTINATION boot NO_CAB FOR bootcd regtest livecd)
add_cd_file(FILE ${CMAKE_SOURCE_DIR}/tools/limine/limine-binary/limine-bios.sys DESTINATION root NO_CAB FOR bootcd regtest livecd)
add_cd_file(FILE ${CMAKE_SOURCE_DIR}/boot/limine.conf DESTINATION boot NO_CAB FOR bootcd regtest livecd)
add_cd_file(FILE ${CMAKE_SOURCE_DIR}/boot/limine.conf DESTINATION efi/boot NO_CAB FOR bootcd regtest livecd)
add_cd_file(FILE ${CMAKE_SOURCE_DIR}/boot/limine.conf DESTINATION root NO_CAB FOR bootcd regtest livecd)

if(DEFINED EFI_PLATFORM_ID)
    # For devices such as USB drives, add also the EFI boot image into efi/boot.
    add_cd_file(TARGET efisys FILE ${CMAKE_CURRENT_BINARY_DIR}/efisys.bin DESTINATION loader NO_CAB FOR bootcd regtest livecd)
endif()
