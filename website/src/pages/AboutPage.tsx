      ...
      <div className="ms-grid-2">
        <div className="ms-card">
          ...
          <ul style={{ paddingLeft: '18px', lineHeight: '1.6', fontSize: '11px', color: '#333' }}>
            <li><strong>Архитектура платформы:</strong> 32-битная архитектура <strong>x86 (IA-32)</strong> с оптимизацией для классических и современных ПК.</li>
            <li><strong>Ядро NT:</strong> Совместимость с системными вызовами и драйверами Windows NT/2000/2003/XP.</li>
            ...
            <li><strong>Стабильный RAM-диск:</strong> Загрузка образа системы прямо в оперативную память (AutoAdminLogon) за 5-15 секунд без падений.</li>
          </ul>
        </div>
