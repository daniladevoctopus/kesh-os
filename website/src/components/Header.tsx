    ...
    <header className="cc-header">
      <div className="cc-container">
        <div className="cc-header-top">
          ...
          {/* Actions: Search + Socials + Theme Toggle */}
          <div className="cc-header-actions">
            <form className="cc-search-form" onSubmit={handleSubmit}>
              <svg
              ...
              <input
                ...
                placeholder="Поиск: USB, LiveCD, KB..."
                value={searchQuery}
            ...
            <a
              ...
              title="Discord сервер SneakDeak Technologies"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="cc-btn cc-btn--github cc-btn--small"
            ...
            <button
              type="button"
              className="cc-btn cc-btn--small cc-btn--icon-only"
              onClick={toggleTheme}
