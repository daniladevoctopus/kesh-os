    ...
    IN PCWSTR ArcPath)
{
    ...
    /* KeshOS NT */
    BootEntry->FriendlyName = L"\"KeshOS NT\"";
    Options->OsLoadOptions  = L"/FASTDETECT /NOEXECUTE=ALWAYSOFF";
    AddBootStoreEntry(BootStoreHandle, BootEntry, MAKESTRKEY(L"ReactOS"));

    /* KeshOS_Debug */
    // BootEntry->BootEntryKey = MAKESTRKEY(L"ReactOS_Debug");
    BootEntry->FriendlyName = L"\"KeshOS (Debug COM1)\"";
    ...
    BootEntry->FriendlyName = L"\"KeshOS (VBox Debug)\"";
    ...
    BootEntry->FriendlyName = L"\"KeshOS (RosDbg)\"";
    ...
    BootEntry->FriendlyName = L"\"KeshOS (Screen Debug)\"";
    ...
    BootEntry->FriendlyName = L"\"KeshOS (Log file)\"";
    ...
    BootEntry->FriendlyName = L"\"KeshOS (RAM Disk)\"";
    ...
    BootEntry->FriendlyName = L"\"KeshOS (Emergency Management Services)\"";
    Options->OsLoadPath     = ArcPath;
