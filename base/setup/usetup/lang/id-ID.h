...
{
    {
        4,
        3,
        " Penyetelan KeshOS " KERNEL_VERSION_STR " ",
    ...
    },
    {
        0,
        20,
        "Harap tunggu saat Penyetelan KeshOS menginisialisasi",
...
static MUI_ENTRY idIDWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Selamat datang di Penyetelan KeshOS",
    ...
    },
    {
        6,
        11,
        "Bagian dari penyetelan ini menyalin Sistem Operasi KeshOS ke",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Tekan ENTER untuk memasang atau meningkatkan KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
     // "\x07  Tekan R untuk memperbaiki instalasi KeshOS menggunakan Konsol Pemulihan.",
        "\x07  Tekan R untuk memperbaiki instalasi KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Tekan L untuk menampilkan Syarat dan Ketentuan Lisensi KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        23,
        "Untuk informasi lebih lanjut terkait KeshOS, mohon kunjungi:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "KeshOS saat ini dalam tahap Alpha, artinya belum lengkap fitur dan",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        12,
        "dalam pengembangan berat. KeshOS direkomendasikan hanya untuk",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "berkenan untuk menjalankan KeshOS pada perangkat keras murni.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Tekan ENTER untuk melanjutkan Penyetelan KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "Sistem KeshOS dilisensikan berdasarkan ketentuan",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Semua perangkat lunak yang menjadi bagian dari sistem KeshOS,",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "Lisensi KeshOS hanya mencakup distribusi ke pihak ketiga.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public License dengan KeshOS silahkan kunjungi",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Penyetelan KeshOS masih dalam tahap pengembangan awal di mana masih",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Penyetelan KeshOS dapat meningkatkan salah satu dari instalasi",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "KeshOS yang tersedia di bawah ini, atau, jika instalasi KeshOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "KeshOS tidak terpasang sepenuhnya.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Komponen dasar KeshOS berhasil dipasang.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Tekan ENTER untuk memasang KeshOS pada partisi terpilih.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "menggunakan format yang tidak didukung oleh KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Agar instalasi KeshOS berhasil, program Penyetelan harus",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "asli setelah menyelesaikan instalasi KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        12,
        "KeshOS) atau program lain yang disediakan oleh pabrik perangkat keras.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "komputer dari harddisk hingga Anda menyelesaikan Penyetelan KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Penyetelan memasang berkas KeshOS pada partisi terpilih. Pilih",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "anda inginkan untuk memasang KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Harap tunggu sementara Penyetelan KeshOS menyalin Berkas ke",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY idIDPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Penyetelan menpersiapkan komputer Anda untuk menyalin berkas KeshOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR idIDErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "KeshOS tidak terpasang sepenuhnya pada komputer\n"
        "anda. Jika anda keluar sekarang, anda akan memulai\n"
        "lagi Penyetelan untuk memasang KeshOS.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Gagal membangun jalur instalasi untuk direktori instalasi KeshOS!\n"
        "ENTER = Mulai ulang komputer"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "Anda tidak dapat memasang KeshOS yang di dalamnya berisi direktori sumber instalasi!\n"
        "ENTER = Mulai ulang komputer"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "Partisi yang dipilih tidak cukup besar untuk memasang KeshOS.\n"
...
MUI_STRING idIDStrings[] =
{
    ...
    "Pilihlah untuk memasang KeshOS pada partisi baru atau yang belum diformat."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "Partisi sistem ini belum diformat."},
    {STRING_NONFORMATTEDOTHERPART,
    "Partisi baru ini belum diformat."},
    {STRING_INSTALLONPART,
    "Penyetelan memasang KeshOS pada Partisi"},
    {STRING_CONTINUE,
    "ENTER = Lanjut"},
    {STRING_QUITCONTINUE,
    "F3 = Keluar  ENTER = Lanjut"},
