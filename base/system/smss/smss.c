      ...
      IN ULONG DebugFlag)
{
    ...
    DbgPrint("KESHOOS: SMSS process running! Initializing...\n");
    ...
    {
        /* Initialize SMSS */
        DbgPrint("KESHOOS: SMSS calling SmpInit...\n");
        ...
        DbgPrint("KESHOOS: SMSS SmpInit passed!\n");
        ...
        DbgPrint("KESHOOS: SMSS executing Winlogon...\n");
