...
IoInitSystem(IN PLOADER_PARAMETER_BLOCK LoaderBlock)
{
    ...
    DbgPrint("KESHOOS: RamDisk init passed\n");
    ...
    DbgPrint("KESHOOS: ARC names created\n");
    ...
    DbgPrint("KESHOOS: Loading system start drivers...\n");
    IopInitializeSystemDrivers();
    PnpSystemInit = TRUE;
    DbgPrint("KESHOOS: System drivers loaded\n");
    ...
    DbgPrint("KESHOOS: ntdll.dll located successfully! IoInitSystem DONE\n");
